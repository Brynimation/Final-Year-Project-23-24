Shader "Custom/DrawProceduralShader"
{
    ...
    SubShader
    {
        ...
        pass
        {
            ...
            ConsumeStructuredBuffer<ThreadIdentifier> _PositionsLOD0;
            ...
            {
                Interpolators o;
                ThreadIdentifier tid = _PositionsLOD0.Consume();
                _ModelMatrix = CreateMatrix(tid.position, float3(1.0, 1.0, 1.0), float3(0.0, 1.0, 0.0), i.instanceId, 10);
                float4 vertexPosOS = float4(tid.position, 0) +  mul(_ModelMatrix, _VertexBuffer[i.vertexId]);//float4(_Positions[i.instanceId] + _VertexBuffer[i.vertexId], 1.0);
                ...
                o.colour = tid.colour + _EmissionColour;
                o.uv = uv;
                return o;
            }/*
            Interpolators vert(Attributes i)
